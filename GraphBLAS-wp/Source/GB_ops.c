...
MONOID ( MIN_   , FP32   , float    , HUGE_VALF  , false ) ;
MONOID ( MIN_   , FP64   , double   , HUGE_VAL   , false ) ;
...
MONOID ( MAX_   , FP32   , float    , -HUGE_VALF , false ) ;
MONOID ( MAX_   , FP64   , double   , -HUGE_VAL  , false ) ;
